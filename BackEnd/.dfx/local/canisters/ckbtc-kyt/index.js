...
import { idlFactory } from './ckbtc-kyt.did.js';
export { idlFactory } from './ckbtc-kyt.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CKBTC-KYT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ckbtc-kyt.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ckbtc-kyt canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ckbtc-kyt.did.js")._SERVICE>}
 */
export const ckbtc-kyt = createActor(canisterId);
