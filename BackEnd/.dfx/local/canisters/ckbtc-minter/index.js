...
import { idlFactory } from './ckbtc-minter.did.js';
export { idlFactory } from './ckbtc-minter.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CKBTC-MINTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ckbtc-minter.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ckbtc-minter canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ckbtc-minter.did.js")._SERVICE>}
 */
export const ckbtc-minter = createActor(canisterId);
