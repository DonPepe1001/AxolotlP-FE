...
export const canisterId = process.env.CKBTC-LEDGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ckbtc-ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ckbtc-ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ckbtc-ledger.did.js")._SERVICE>}
 */
export const ckbtc-ledger = createActor(canisterId);
